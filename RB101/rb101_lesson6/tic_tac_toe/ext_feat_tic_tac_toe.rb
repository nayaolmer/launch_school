...
loop do 
  ...
  loop do
    ...
    start_user = ['Computer','Player'].sample 
    prompt("#{start_user} will begin the game.")

    game_board = initialize_board
    display_board(game_board) if start_user == "Player"
    loop do
      if start_user == 'Player'
        player_places_piece!(game_board)
        computer_places_piece!(game_board)
      elsif start_user == 'Computer'
        computer_places_piece!(game_board)
